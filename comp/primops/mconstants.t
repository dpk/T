...
(define-constant M68-JUMP-ABSOLUTE #x4ef9)
(define-constant JUMP-ABSOLUTE M68-JUMP-ABSOLUTE)

;++ in t3 this will be #x1FFFFFFF fix later
;(define-constant most-positive-fixnum         #x3ffffff)
...
;(define-constant most-negative-fixnum         #x-3fffff)
...
;(define-constant most-positive-fixnum       #x1fffffff)
;(define-constant maximum-fixnum             #x1fffffff)
;(define-constant max-fixnum                 #x1fffffff)
(define-constant maximum-fixnum-as-string   "536870911")

;(define-constant most-negative-fixnum       #x-20000000)
;(define-constant minimum-fixnum             #x-20000000)
;(define-constant min-fixnum                 #x-20000000)
(define-constant minimum-fixnum-as-string   "-536870912")
...
;;; The high two bits of vector headers must be 0 so that vector length can
;;; be determined using (ashl v -6).  Bit 7 is not used.
...
(define-constant header/template       #b1000001) ;needed for vax compatability
(define-constant header/cell           #b1001001)  ;; ???
;++(define-constant header/weak           #b1010001)
(define-constant header/task           #b1011101)  ;; ???
...
(define-constant header/double-float-vector    #b0001101) 
...
(define-constant %%task-header-offset    -80)
